    ...
    <>
      <div className='cont_01 mt-5'>
        ...
        <div id='main_body'>
          ...
          <input type="text" className="form-control" placeholder='indirizzo' id="indirizzo" onChange={(val)=>{setOggetto([{indirizzo:val.target.value}])}}/>
          ...
          <input type="email" className="form-control" placeholder='pec' id="pec" onChange={(val)=>{setOggetto([{pec:val.target.value}])}}/>
          <input type="text" className="form-control" placeholder="fax" id="fax" onChange={(val)=>{setOggetto([{fax:val.target.value}])}}/>
